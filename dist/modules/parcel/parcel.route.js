...
router.route("/").post((0, Validation_1.validation)(parcel_validator_1.parcelCreateZodSchema), (0, CheckAuth_1.checkAuth)([user_interface_1.Role.ADMIN, user_interface_1.Role.SENDER]), parcel_controller_1.parcelControllers.createParcel);
...
router.route("/:id/approve").patch((0, CheckAuth_1.checkAuth)([user_interface_1.Role.RECEIVER, user_interface_1.Role.ADMIN]), parcel_controller_1.parcelControllers.approveParcel);
